...
<form action="" method="post">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            <div class="pt-5">
    <p>Category:<a href="#">{{ $category->cat_name }}</a></p>
</div>
    ...
    <div class="categories">
        <h3>Categories</h3>
        <!-- Loop through categories with car counts -->
        @foreach($categories as $category)
            @php
                $cars = \App\Models\Car::where('category_id', $category->id)->get();
                $carCount = $cars->count();
            @endphp
            <li>
                <a href="#">{{ $category->cat_name }} <span>({{ $carCount }})</span></a>
                <!-- Display cars in this category -->
